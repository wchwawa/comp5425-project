...
async function main() {
  ...
  try {
    ...
    console.log("\nNumber of sources:", ragResult.metadata.length);
    console.log("First source:", ragResult.metadata[0].title);
  } catch (error) {
  ...
  try {
    ...
    console.log("\nNumber of sources:", filteredResult.metadata.length);
    if (filteredResult.metadata.length > 0) {
      console.log("First source tags:", filteredResult.metadata[0].tags);
    }
  } catch (error) {
  ...
  try {
    ...
    console.log("\nNumber of sources:", queryResult.metadata.length);
  } catch (error) {
